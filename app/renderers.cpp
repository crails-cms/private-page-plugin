...
#include "lib/renderers/private_page_plugin_html_renderer.hpp"
#include "lib/renderers/private_page_plugin_json_renderer.hpp"
#include <iostream>
...
void initialize_plugin_renderers()
{
  ...
  PrivatePagePluginHtmlRenderer plugin_html;
  PrivatePagePluginJsonRenderer plugin_json;
